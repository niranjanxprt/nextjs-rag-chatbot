...
export default function KnowledgeBase() {
  ...
  const [statusFilter, setStatusFilter] = useState<'all' | 'processing' | 'indexed' | 'failed'>(
    'all'
  )
      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 border border-dashed border-border rounded-lg">
            ...
            <p className="text-sm font-medium text-foreground mb-1">No foundation documents yet</p>
          ...
          <div className="text-center py-12 border border-dashed border-border rounded-lg">
            ...
            <p className="text-sm font-medium text-foreground mb-1">No matching documents</p>
        ...
        <AlertDialog open={!!deletingDoc} onOpenChange={() => setDeletingDoc(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to remove "{deletingDoc?.filename}" from the workspace
