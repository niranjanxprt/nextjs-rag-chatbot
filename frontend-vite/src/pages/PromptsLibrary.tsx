...
export default function PromptsLibrary() {
  ...
  return (
    <AppLayout>
      <div className="p-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="hide-system" className="text-sm font-normal cursor-pointer">
              Hide system prompts
            </Label>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="border border-dashed border-border rounded-lg p-12 flex flex-col items-center justify-center text-center">
            {prompts.length === 0 ? (
              <>
                <h3 className="font-medium text-foreground mb-1">No prompts yet</h3>
                <p className="text-sm text-muted-foreground mb-4 max-w-sm">
                  Create your first prompt template to quickly reuse common questions across your
                  projects.
                </p>
              ...
              <>
                <h3 className="font-medium text-foreground mb-1">No matching prompts</h3>
      ...
      {/* Create Prompt Modal */}
      <PromptModal open={isModalOpen} onOpenChange={setIsModalOpen} onSubmit={handleCreatePrompt} />
      ...
      <AlertDialog open={!!deletingPrompt} onOpenChange={() => setDeletingPrompt(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{deletingPrompt?.title}"? This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
